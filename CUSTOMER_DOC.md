...
|------|------------------------------|----------------|------------------|---------------------|
| 1    | `u5_fu_zpczsqdmx01`         | 资产处置申请单明细 | `assetDisposal`  | 资产处置申请单明细.csv |
| 2    | `u5_fu_zppdqd01`            | 资产盘点单明细   | `assetInventory` | 资产盘点单明细.csv     |
| 3    | `u5_fu_zpzyqdmx01`          | 资产转移单明细   | `assetTransfer`  | 资产转移单明细.csv     |

---

## 5. 表字段中英文对应关系

### 5.1 资产处置申请单明细（`u5_fu_zpczsqdmx01`）
...
| 日期       | 变更内容 | 说明                                  |
|-----------|---------|---------------------------------------|
| 2026-07-15 | 字段重命名 | 资产转移单明细表中"资产转移单状态"更名为"单据描述"，对应数据库字段 `transfer_desc`，前端 CSV 导出同步更新。 |
